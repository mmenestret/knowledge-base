...
4. Lance la compilation de ce fichier en suivant les instructions de `/wiki:compiler` (lis `.claude/commands/wiki/compiler.md` et execute le workflow sur le fichier cree).

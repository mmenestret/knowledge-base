...
6. Pour chaque output :
   ...
   c. **Extraction selective** : compare l'output avec les articles existants. N'integre que les elements absents du wiki : connexions inedites, precisions, angles nouveaux. Ignore ce qui est deja present.
